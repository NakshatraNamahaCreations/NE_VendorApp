...
function ProductDetails({ route }) {
  ...
  const getYouTubeId = url => {
    try {
      ...
      } else if (cleanUrl.hostname.includes('youtube.com')) {
  ...
  return (
    <View style={{ backgroundColor: 'white', height: '100%' }}>
      ...
      <ScrollView>
        <View
          ...
          <View style={{ width: '100%', height: 350, marginBottom: 10 }}>
            ...
            <Image
              source={{
                uri: `${mainMedia.replace(/\\/g, '/')}?${new Date().getTime()}`,
              }}
              style={[styles.mainMedia, { marginTop: 20 }]}
              resizeMode="contain"
            />
          ...
          <View style={{ marginTop: 20 }}>
            ...
            {/* make it uncommand when the ecommerece part is active */}
            {/* <TouchableOpacity
              style={{
                borderRadius: 20,
                borderColor: '#616161',
      ...
      {/*make it uncommand later once ecommerce is active */}
      {/* <TouchableOpacity
        style={{
          backgroundColor: THEMECOLOR.mainColor,
          paddingVertical: 10,
