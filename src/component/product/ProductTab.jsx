            ...
            <TouchableOpacity onPress={() => handleTabClick('details')}>
              <Text
                style={{
                  ...
                  fontSize: 13,
                  color: productDetails ? THEMECOLOR.mainColor : '#8d8d8d',
                  textAlign: 'center',
                }}>
                Product Details
              </Text>
            ...
            <TouchableOpacity onPress={() => handleTabClick('origin')}>
              <Text
                style={{
                  ...
                  fontSize: 13,
                  textAlign: 'center',
                  color: coutryOfOrgin ? THEMECOLOR.mainColor : '#8d8d8d',
                }}>
                Country Of Orgin
              </Text>
              <View
            ...
            <TouchableOpacity onPress={() => handleTabClick('manufacturer')}>
              <Text
                style={{
                  fontFamily: 'Montserrat-Medium',
                  fontSize: 13,
                  color: manufacturer ? THEMECOLOR.mainColor : '#8d8d8d',
                  textAlign: 'center',
                }}>
                Manufacturer
              </Text>
      ...
      <View style={{ marginTop: 10 }}>
        {productSpecification ? (
          ...
          <View>
            ...
            <View style={styles.productsDetasilRow}>
              <View style={{ flex: 0.5 }}>
                <Text style={styles.productDetailsHead}>Description</Text>
              </View>
              <View style={{ flex: 0.5 }}>
                <Text style={styles.productsDetailsAns}>
                  {product.product_description ? product.product_description : 'N/A'}
                </Text>
              </View>
            </View>
          </View>
