...
export default function ProductType({vendorData}) {
  ...
  const [onFocus, setOnFocus] = useState('rental');
  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white', height: '100%'}}>
      ...
      <View
        ...
        <RadioButton
          value="technician"
          status={onFocus === 'technician' ? 'checked' : 'unchecked'}
          onPress={() => setOnFocus('technician')}
        />
        <Text
          style={{
            fontFamily: 'Montserrat-SemiBold',
      ...
      {onFocus === 'technician' && <AddEngineer vendorData={vendorData} />}
      {/* {onFocus === 'Sell' && (
        <>
